...
![Composicion en UML](./Media/composicion.png)
...
![agregacion en UML](./Media/agregacion.png)
...
````
![asociacion en UML](./Media/asociacion.png)
### Dependencia
...
````
![dependencia en UML](./Media/dependencia.png)
